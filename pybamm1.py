# ----------------------------------------------
# run SPM in PyBaMM: Monica's code - aging without pulsing?
...
start_time_pulse_test = solution_pulse_test["Time [s]"].entries[0]
end_time_pulse_test = solution_pulse_test["Time [s]"].entries[-1]
